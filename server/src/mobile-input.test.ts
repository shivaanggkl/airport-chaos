...
import{joystickInput,normalizeGraphicsQuality,normalizeTouchMode,pinchZoomFactor,resolvedGraphicsQuality,throttleLeverState}from'../../shared/mobile-input-rules.mjs';
