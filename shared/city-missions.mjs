...
export const cityMissionCatalog = Object.freeze({
  dallas: Object.freeze([
    ...
    mission(20, 'three-territory-offensive', 'territorySequence', 'THREE-TERRITORY OFFENSIVE', 'Capture South Metro, Canal District, then Central District in order.', 'EXTREME', 3_500, 4_500, { territoryIds: ['dallas-executive', 'las-colinas', 'downtown'] }, 1),
